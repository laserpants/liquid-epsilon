...
$UHC.$MutVar.$_24D__MutVarNEW14UNQ45SDCGENDatatype=
 new _F_(function($_24D__MutVar)
         {var $_24D__MutVar2=
           new _A_($UHC.$MutVar.$_24D__MutVarNEW16UNQ46EVLSDCGENDatatype,[$_24D__MutVar]);
          return $_24D__MutVar2;});
$UHC.$MutVar.$_24D__MutVarNEW16UNQ46EVLSDCGENDatatype=
 new _F_(function($_24D__MutVar)
         {var $Datatype__=
...
$UHC.$MutVar.$_24D__MutVarUNQ45SDCGENDatatype=
 new _A_(new _F_(function()
                 {return new _A_($UHC.$MutVar.$_24D__MutVarNEW14UNQ45SDCGENDatatype,[$UHC.$MutVar.$_24D__MutVarUNQ45SDCGENDatatype]);}),[]);
...
$UHC.$MutVar.$__Rep1MutVarDFLUHC_2eBase_2efrom1GENRepresentable1=
 new _F_(function($x)
         {return $UHC.$Base.$undefined;});
$UHC.$MutVar.$__Rep1MutVarNEW23UNQ36SDCGENRepresentable1=
 new _F_(function($__)
         {var $__2=
           new _A_($UHC.$MutVar.$__Rep1MutVarNEW25UNQ37EVLSDCGENRepresentable1,[$__]);
          return $__2;});
$UHC.$MutVar.$__Rep1MutVarNEW25UNQ37EVLSDCGENRepresentable1=
 new _F_(function($__)
...
$UHC.$MutVar.$__Rep1MutVarUNQ36SDCGENRepresentable1=
 new _A_(new _F_(function()
                 {return new _A_($UHC.$MutVar.$__Rep1MutVarNEW23UNQ36SDCGENRepresentable1,[$UHC.$MutVar.$__Rep1MutVarUNQ36SDCGENRepresentable1]);}),[]);
...
$UHC.$MutVar.$__Rep0MutVarDFLUHC_2eBase_2eto0GENRepresentable0=
 new _F_(function($proj__1)
         {return $UHC.$Base.$undefined;});
$UHC.$MutVar.$__Rep0MutVarNEW32UNQ27SDCGENRepresentable0=
 new _F_(function($__)
         {var $__2=
           new _A_($UHC.$MutVar.$__Rep0MutVarNEW34UNQ28EVLSDCGENRepresentable0,[$__]);
          return $__2;});
$UHC.$MutVar.$__Rep0MutVarNEW34UNQ28EVLSDCGENRepresentable0=
 new _F_(function($__)
...
$UHC.$MutVar.$__Rep0MutVarUNQ27SDCGENRepresentable0=
 new _A_(new _F_(function()
                 {return new _A_($UHC.$MutVar.$__Rep0MutVarNEW32UNQ27SDCGENRepresentable0,[$UHC.$MutVar.$__Rep0MutVarUNQ27SDCGENRepresentable0]);}),[]);
$UHC.$MutVar.$__Rep0MutVarGENRepresentable0=
 new _A_(new _F_(function()
                 {return $UHC.$MutVar.$__Rep0MutVarUNQ27SDCGENRepresentable0;}),[]);
$UHC.$MutVar.$s2NEW40UNQ63=
 new _F_(function($__)
         {var $__2=
           _e_($__);
          return $__2[0];});
$UHC.$MutVar.$vNEW43UNQ64=
 new _F_(function($__)
         {var $__2=
           _e_($__);
          return $__2[1];});
$UHC.$MutVar.$__88__472__0NEW46UNQ65=
 new _F_(function($f,$v,$s2)
         {var $__=
           _e_($s2);
          return new _A_($f,[$v]);});
$UHC.$MutVar.$vnewNEW51UNQ66=
 new _F_(function($__)
         {var $__2=
           _e_($__);
          return $__2[0];});
$UHC.$MutVar.$vresNEW55UNQ67=
 new _F_(function($__)
         {var $__2=
           _e_($__);
          return $__2[1];});
$UHC.$MutVar.$atomicModifyMutVar=
 new _F_(function($mv,$f,$s1)
         {var $__=
          ...
          var $s2=
           new _A_($UHC.$MutVar.$s2NEW40UNQ63,[$__]);
          var $v=
           new _A_($UHC.$MutVar.$vNEW43UNQ64,[$__]);
          var $__7=
           new _A_($UHC.$MutVar.$__88__472__0NEW46UNQ65,[$f,$v,$s2]);
          var $vnew=
           new _A_($UHC.$MutVar.$vnewNEW51UNQ66,[$__7]);
          var $s3=
           new _A_($UHC.$MutVar.$writeMutVar,[$mv,$vnew,$s2]);
          var $vres=
           new _A_($UHC.$MutVar.$vresNEW55UNQ67,[$__7]);
          return [$s3,$vres];});
